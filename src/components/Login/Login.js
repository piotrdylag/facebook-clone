...
function Login() {
    //TODO Repair firebase import error!
    ...
    return (
        <div className="login">
            ...
            <div className="login__form">
                <form>
                    <input placeholder="Email or Phone Number" type="text" className="login__form"/>
                    <input placeholder="Password" type="password" className="login__form"/>
                </form>
            </div>
